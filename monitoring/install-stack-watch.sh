...
#
#   media-stack-watch     `check` every 15 minutes: containers, Jellyfin, Docker, and the
#                         "host is unreachable" dead man's switch
...
write_service "$CHECK" "Media stack watch: containers, Jellyfin and host heartbeat" check
