...
MUTANTS: list[tuple[str, str, str, str]] = [
    ...
    ("SP15", 'if SEERR_CONTAINER in config["services"] and f"service:{SEERR_CONTAINER}" not in problems:',
     'if SEERR_CONTAINER in config["services"] and not problems:',
     "any unrelated stopped service skips the check, and an unpatched Seerr reads as Cleared"),
    ("SP16", '        elif f"service:{SEERR_CONTAINER}" in problems and SEERR_PATCH in previous:',
