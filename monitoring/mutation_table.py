...
MUTANTS: list[tuple[str, str, str, str]] = [
    ...
    ("SP21", 'if patch and patch["count"] > 1 and', 'if patch and',
     "a stale unpatched sighting rewords a fresh failed read as unpatched"),
    ("SP22", 'and previous[SEERR_PATCH]["description"] == SEERR_UNPATCHED:', ":",
     "a Seerr only ever unreadable is reported as running unpatched"),
